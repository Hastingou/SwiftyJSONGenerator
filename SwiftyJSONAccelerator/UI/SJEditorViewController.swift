...
class SJEditorViewController: NSViewController, NSTextViewDelegate {
    ...
    @IBOutlet var isOptionalCheckbox: NSButton!
    @IBOutlet var isVariableCheckbox: NSButton!
   ...
   */
    func generateModel() {
        ...
        if object != nil {
            ...
            let configuration = ModelGenerationConfiguration.init(
                                                                  ...
                                                                  isOptional: self.isOptionalCheckbox.state.rawValue == 1,
                                                                  isVariable: self.isVariableCheckbox.state.rawValue == 1
            )
    ...
    @IBAction func recalcEnabledBoxes(_ sender: AnyObject) {
        ...
        self.isOptionalCheckbox.state = (modelTypeSelectorSegment.selectedSegment == 1) ? .on : .off
        self.isVariableCheckbox.state = (modelTypeSelectorSegment.selectedSegment == 1) ? .on : .off
    }
